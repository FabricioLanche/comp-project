...
define i32 @main() {
  %1 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (float, ptr null, i32 65536) to i64))
  ...
  %5 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %4, i64 256, 3, 0
  %6 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %5, i64 256, 3, 1
  %7 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %6, i64 256, 4, 0
  %8 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %7, i64 1, 4, 1
  %9 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (float, ptr null, i32 65536) to i64))
  ...
  %13 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %12, i64 256, 3, 0
  %14 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %13, i64 256, 3, 1
  %15 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %14, i64 256, 4, 0
  %16 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %15, i64 1, 4, 1
  %17 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (float, ptr null, i32 65536) to i64))
  ...
  %21 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %20, i64 256, 3, 0
  %22 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %21, i64 256, 3, 1
  %23 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %22, i64 256, 4, 0
...
54:                                               ; preds = %40
  ...
  %77 = load float, ptr %76, align 4
  %78 = getelementptr float, ptr %17, i64 255
  %79 = load float, ptr %78, align 4
  %80 = getelementptr float, ptr %17, i64 65408
  %81 = load float, ptr %80, align 4
  %82 = fcmp oeq float %77, 2.560000e+02
  %83 = fcmp oeq float %79, 2.560000e+02
  %84 = fcmp oeq float %81, 2.560000e+02
  %85 = and i1 %82, %83
  %86 = and i1 %85, %84
