...
define i32 @main() {
  %1 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (float, ptr null, i32 262144) to i64))
  ...
  %9 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (float, ptr null, i32 262144) to i64))
  ...
  %13 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %12, i64 512, 3, 0
  ...
  %17 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (float, ptr null, i32 262144) to i64))
  ...
  %22 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %21, i64 512, 3, 1
  %23 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %22, i64 512, 4, 0
...
54:                                               ; preds = %40
  ...
  %77 = load float, ptr %76, align 4
  %78 = getelementptr float, ptr %17, i64 511
  %79 = load float, ptr %78, align 4
  %80 = getelementptr float, ptr %17, i64 261888
  %81 = load float, ptr %80, align 4
  %82 = fcmp oeq float %77, 5.120000e+02
  %83 = fcmp oeq float %79, 5.120000e+02
  %84 = fcmp oeq float %81, 5.120000e+02
  %85 = and i1 %82, %83
  %86 = and i1 %85, %84
